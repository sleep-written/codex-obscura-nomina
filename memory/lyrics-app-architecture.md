...
1. **Texto plano (textarea) → AST:** requiere un motor de fonética/silabeo español que calcule desde cero qué posiciones son alterables (diptongos/hiatos naturales, fronteras de palabra vocal-vocal) y su estado natural por defecto.
